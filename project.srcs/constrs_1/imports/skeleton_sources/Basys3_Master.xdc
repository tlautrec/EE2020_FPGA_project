...
## Switches
set_property PACKAGE_PIN V17 [get_ports {CURSOR_1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CURSOR_1}]
set_property PACKAGE_PIN V16 [get_ports {CURSOR_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CURSOR_2}]
#set_property PACKAGE_PIN W16 [get_ports {CURSOR_2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {CURSOR_2}]
...
set_property PACKAGE_PIN W2 [get_ports {CURSOR_SELECT}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CURSOR_SELECT}]
set_property PACKAGE_PIN U1 [get_ports {SINGLE_ADJUST}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SINGLE_ADJUST}]
set_property PACKAGE_PIN T1 [get_ports {TRIGGER_TYPE}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {TRIGGER_TYPE}]
set_property PACKAGE_PIN R2 [get_ports {TRIGGER}]					
